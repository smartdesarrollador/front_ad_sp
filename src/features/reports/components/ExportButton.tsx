...
function ExportButtonInner({ className }: Props) {
...
function DisabledExportButton({ className }: Props) {
  return (
...
export function ExportButton({ className }: Props) {
  return (
    <FeatureGate
      ...
      fallback={<DisabledExportButton className={className} />}
    >
      <ExportButtonInner className={className} />
    </FeatureGate>
  )
}
